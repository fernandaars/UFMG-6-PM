...
public class Tp1 {
    ...
    public static void main(String[] args) {
        ...
        firstPosition = new Square(x = rand.nextInt(sizeOfBoard - 1), y = rand.nextInt(sizeOfBoard - 1));
        ...
        if(Tp1.solution.findSolution(firstPosition, sizeOfBoard) ==  true){
            ...
            System.out.println("Números de Casas Visitadas: "+Tp1.solution.numOfMoves);
        }else{
        ...
        System.out.println();
        System.out.println("OBSERVAÇÃO: \nEste programa utiliza o ALGORITMO DE WARNSDORFF para encontrar o PASSEIO DO CAVALO em exatos 64 movimentos.");
        System.out.println("Dessa forma, a escolha do ponto inicial NÃO interfere no tempo de execução do programa e nem na quantidade");
        System.out.println("de movimentos executados. A prova matemática dessa afirmação se encontra na documentação do trabalho.");
    }
}